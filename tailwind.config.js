...
module.exports = {
  ...
  theme: {
    colors: {
      ...
      // Shifting background to a slightly "warm" deep forest black
      background: "#010402", 
    ...
    spacing: {
      0: '0rem', 1: '0.4rem', 2: '0.8rem', 3: '1.2rem', 4: '1.6rem', 5: '2rem',
      6: '2.4rem', 7: '2.8rem', 8: '3.2rem', 9: '3.6rem', 10: '4rem',
      11: '4.4rem', 12: '4.8rem', 14: '5.6rem', 15: '6rem', 16: '6.4rem'
    },
    aspectRatio: {
      '1/0.7': '1 / 0.7'
    },
    backgroundImage: {
      // NEW GREEN GRADIENTS
      "primary-gradient": 'linear-gradient(92.88deg, #059669 9.16%, #10b981 43.89%, #34d399 64.72%)',
      "page-gradient": "radial-gradient(ellipse 80% 50% at 50% -20%, rgba(16, 185, 129, 0.2), transparent);",
      "hero-gradient": "radial-gradient(ellipse 50% 80% at 20% 40%, rgba(5, 150, 105, 0.1), transparent), radial-gradient(ellipse 50% 80% at 80% 50%, rgba(16, 185, 129, 0.15), transparent);",
      "hero-glow": "conic-gradient(from 230.29deg at 51.63% 52.16%, #064e3b 0deg, #10b981 67.5deg, #059669 198.75deg, #047857 251.25deg, #10b981 301.88deg, #34d399 360deg)",
      "glow-lines": "linear-gradient(var(--direction), #10b981 0.43%, #059669 14.11%, rgba(16, 185, 129, 0) 62.95%)",
      ...
      "feature-image": "linear-gradient(rgba(16, 185, 129, 0.3), rgba(255, 255, 255, 0) 120%)",
      ...
      "feature-divider": "conic-gradient(from 90deg at 80% 50%, #010402, var(--feature-color))",
      "integrations": "linear-gradient(rgba(16, 185, 129, 0.3), rgba(255, 255, 255, 0) 120%)",
      "integrations2": 'linear-gradient(rgba(5, 150, 105, 0.3) 0%, rgba(16, 185, 129, 0.3) 100%)',
      "ripple-gradient": "linear-gradient(90deg, #022c22 0%, #059669 100%);"
    },
    boxShadow: {
      primary: 'rgba(16, 185, 129, 0.4) 0px 1px 40px'
    },
    keyframes: {
      "fade-in": {
      ...
      "ripple": {
        ...
        "40%, 50%": { opacity: 'var(--opacity)', transform: "translate(-50%, -50%) scale(1)" },
        "100%": { opacity: 0 },
      }
    },
    animation: {
